...
<?php while (have_posts()) : the_post() ?>
    <div class="row project__hero py-5">
        <h1 class="col-12 project__hero__title my-5 text-center"><?= get_the_title(); ?></h1>
        <div class="col-12 project__hero__thumbnail">
            <?php the_post_thumbnail('large', ['class' => 'project__hero__thumbnail__img']); ?>
        </div>
    </div>

    <div class="row project__info py-5 mt-5">
        <p class="col-12 project__info__client"><?= get_field('client'); ?></p>
        <h2 class="col-12 project__info__subtitle"><?= get_field('subtitle'); ?></h2>
    </div>

    <div class="row project__details py-5 d-flex flex-column align-items-end">
        <p class="col-12 project__details__description"><?= get_field('description'); ?></p>
        <div class="col-6 ps-5 py-5">
    ...
    ?>
        <div class="col-12 project__gallery__image my-4">
